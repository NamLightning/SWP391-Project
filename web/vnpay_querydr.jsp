    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="vnpayquery" id="frmQerydr" method="Post">
                ...
                <label for="order_id">Transaction code to be required (Values of vnp_TxnRef)</label>
                <input class="form-control" id="order_id"
                       name="order_id" type="text"/>
                </div>
                <div class="form-group">
                <label for="trans_date">Transaction initiation time (Values of vnp_CreateDate transaction required)</label>
