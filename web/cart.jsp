                ...
                <div class="shopping-cart-layout">
                            ...
                            <div class="product-list">
                                <div class="product-item">
                                    ...
                                    <div class="product-details">
                                        <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/89a9ba1deb831d0eb4b10822e08b22bbc79c2a4571dae5d55b5c790bd9e1e3ba?placeholderIfAbsent=true&apiKey=5ab9b8f40f3f4c73bf963337551ad1d8" alt="Dog Leash" class="product-cart-image" />
                                        <span class="product-name">Dog Leash - Size M - Vani</span>
                                    </div>
                                    <span class="product-price">199.000₫</span>
                                    <div class="quantity-selector">
                                        <div class="quantity-button">
                                            <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/ba388e0eabad954235024ee887707edd5d6e5c8af2f51cf95d84f47e8d6d2fd9?placeholderIfAbsent=true&apiKey=5ab9b8f40f3f4c73bf963337551ad1d8" class="img-8" alt="Decrease quantity" onclick="decreaseQuantity('quantity-1')" />
                                            <div data-layername="01" class="quantity-value" id="quantity-1">01</div>
                                            <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/c4ef0281caf6e16bf01681ba248222d77473d0422e9e910a1484d63287f291cf?placeholderIfAbsent=true&apiKey=5ab9b8f40f3f4c73bf963337551ad1d8" class="img-9" alt="Increase quantity" onclick="increaseQuantity('quantity-1')" />
                                        </div>
                                    </div>
                                ...
                                <div class="product-item">
                                    ...
                                    <div class="product-details">
                                        <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/8ee76b8c06d5632fe5c8151a61e621e575d08ed3fd356204be34d4b39267b9df?placeholderIfAbsent=true&apiKey=5ab9b8f40f3f4c73bf963337551ad1d8" alt="Sajo Pet Food" class="product-cart-image" />
                                        <span class="product-name">Sajo Pet Food - 20kg</span>
                                    </div>
                                    <span class="product-price">345.000₫</span>
                                    <div class="quantity-selector">
                                        <div class="quantity-button">
                                            <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/ba388e0eabad954235024ee887707edd5d6e5c8af2f51cf95d84f47e8d6d2fd9?placeholderIfAbsent=true&apiKey=5ab9b8f40f3f4c73bf963337551ad1d8" class="img-8" alt="Decrease quantity" onclick="decreaseQuantity('quantity-2')" />
                                            <div data-layername="01" class="quantity-value" id="quantity-2">03</div>
                                            <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/c4ef0281caf6e16bf01681ba248222d77473d0422e9e910a1484d63287f291cf?placeholderIfAbsent=true&apiKey=5ab9b8f40f3f4c73bf963337551ad1d8" class="img-9" alt="Increase quantity" onclick="increaseQuantity('quantity-2')" />
                                        </div>
                                    </div>
                    ...
                    <div class="cart-summary-column">
                        <div class="cart-total">
                            ...
                            <button class="buy-now-button" onclick="window.location.href = 'checkOut.jsp'">
