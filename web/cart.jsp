                                    ...
                                    <div class="product-list">
                                        ...
                                        <c:forEach var="c" items="${carts}">
                                            ...
                                            <div class="product-item" id="product-${c.getCartItemID()}">
                                                ...
                                                <div class="quantity-selector">
                                                    <div class="quantity-button">
                                                        <button type="button" class="img-8" onclick="window.location.href = '${removeLink}'"><i class="fas fa-minus"></i></button>
                                                        <div class="quantity-value" id="quantity-${c.getCartItemID()}">${c.getQuantity()}</div>
                                                        <button type="button" class="img-9" onclick="window.location.href = '${cartLink}'"><i class="fas fa-plus"></i></button>
                                                    </div>
                                                </div>
