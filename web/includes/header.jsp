                ...
                <header class="header">
                    ...
                    <nav class="main-nav">
                        ...
                        <form class="search-container">
                            ...
                            <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/9d436954de593ec919b21d217bc0d246be46f30701546ac1c3e383bef3069af0?placeholderIfAbsent=true&apiKey=5ab9b8f40f3f4c73bf963337551ad1d8" alt="Cart Icon" class="cart-icon" id="hoverItem2" onclick="location.href = 'cart.jsp'">
...
<!--                                                    <img src="${reuse.loadImage(pDAO.checkExist(c.getProductID()).getAvatar_img())}" alt="..." class="product-image">-->
                                                    <img src="${pageContext.request.contextPath}/images/food7.jpg" alt="..." class="product-cart-image">
                                                    <div class="product-popup-details">
                                                        ...
                                                        <div class="product-popup-price">
                                                            <span class="quantity-popup">${c.getQuantity()}</span> <span>x</span> <span class="price-popup">${pDAO.checkExist(c.getProductID()).getPrice()}<h6>₫</h6></span>
                                                        </div>
                                                    </div>
