                ...
                <header class="header">
                    ...
                    <nav class="main-nav">
                        ...
                        <form class="search-container">
                            ...
                            <a href="cart.jsp" style="text-decoration: none;"><img src="https://cdn.builder.io/api/v1/image/assets/TEMP/45b4a97be78e3927557d72496281145219fc1416258a4802e859df73cb06928a?placeholderIfAbsent=true&apiKey=1d890b3ac32c4e0faad33073d6425f1b" alt="Cart Icon" class="cart-icon"></a>
                        </form>
                    </nav>
                </header>
            </div>
