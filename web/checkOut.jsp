...
<html lang="en">
    ...
    <body>
        <%
            ...
            pageContext.setAttribute("customer", c1);
        %>
                        ...
                        <section class="checkout-container">
                            ...
                            <div class="checkout-information">
                                ...
                                <div class="form-container">
                                    <div class="name-company-container">
                                        <div class="name-fields">
                                            <div class="input-group">
                                                <label for="firstName" class="input-label" placeholder="First name">First
                                                    name</label>
                                                <input type="text" id="firstName" class="input-field" value="${customer.getFirstName()}" required>
                                            </div>
                                            <div class="input-group">
                                                <label for="lastName" class="input-label" placeholder="Last name">Last
                                                    name</label>
                                                <input type="text" id="lastName" class="input-field" value="${customer.getLastName()}" required>
                                            </div>
                                        </div>
                                        <div class="company-field">
                                            <label for="companyName" class="input-label">Company Name (Optional)</label>
                                    ...
                                    <div class="address-field">
                                        <label for="address" class="input-label">Address</label>
                                        <input type="text" id="address" class="address-input" value="${customer.getAddress()}" required>
                                    </div>
                                    <div class="contact-fields">
                                        <div class="email-field">
                                            <label for="email" class="input-label">Email</label>
                                            <input type="email" id="email" class="contact-input" value="${customer.getEmail()}" required>
                                        </div>
                                        <div class="phone-field">
                                            <label for="phone" class="input-label">Phone Number</label>
                                            <input type="tel" id="phone" class="contact-input" value="${customer.getPhoneNumber()}" required>
                                        </div>
                                    </div>
                                </div>
